...
const MESSAGES = {
  en: {
    ...
    ticketsHead: 'My tickets · {n}',
    ticketsSummary: '{closed} closed · SLA {hit} of {sla}',
    ...
    ticketsFailed: 'Could not load the tickets — {error}',
    ...
    pickAction: 'Choose',
    staleData: 'Showing the last good data — {error}',
    justNow: 'just now',
    ...
    operatorsFailed: 'Could not read {host}/api/summary — {error}',
  ...
  ru: {
    ...
    ticketsHead: 'Мои заявки · {n}',
    ticketsSummary: 'закрыто: {closed} · SLA {hit} из {sla}',
    ...
    ticketsFailed: 'Не удалось загрузить заявки — {error}',
    ...
    pickAction: 'Выбрать',
    staleData: 'Показаны последние удачные данные — {error}',
    justNow: 'только что',
    ...
    operatorsFailed: 'Не удалось прочитать {host}/api/summary — {error}',
  ...
  uz: {
    ...
    ticketsHead: 'Mening arizalarim · {n}',
    ticketsSummary: '{closed} yopilgan · SLA {hit} / {sla}',
    ...
    ticketsFailed: 'Arizalarni yuklab boʻlmadi — {error}',
    ...
    pickAction: 'Tanlash',
    staleData: 'Oxirgi muvaffaqiyatli maʼlumot koʻrsatilmoqda — {error}',
    justNow: 'hozirgina',
    ...
    operatorsFailed: '{host}/api/summary oʻqilmadi — {error}',
