...
const MESSAGES = {
  en: {
    ...
    ticketsAiLow: 'Only AI < 60',
    updateTitle: 'Version {v} is out',
    updateHow: 'You have {current}. Download the zip, unpack it over the old folder, then press ⟳ on KPI px in chrome://extensions.',
    updateAction: 'Download',
    badgeUpdate: 'update {v} available',
  ...
  ru: {
    ...
    ticketsAiLow: 'Только AI < 60',
    updateTitle: 'Вышла версия {v}',
    updateHow: 'У вас {current}. Скачайте zip, распакуйте поверх старой папки и нажмите ⟳ у KPI px в chrome://extensions.',
    updateAction: 'Скачать',
    badgeUpdate: 'доступно обновление {v}',
  ...
  uz: {
    ...
    ticketsAiLow: 'Faqat AI < 60',
    updateTitle: '{v} versiyasi chiqdi',
    updateHow: 'Sizda {current}. Zip’ni yuklab oling, eski papka ustiga oching, soʻng chrome://extensions’da KPI px yonidagi ⟳ ni bosing.',
    updateAction: 'Yuklab olish',
    badgeUpdate: '{v} yangilanishi mavjud',
